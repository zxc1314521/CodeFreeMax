  ...
  const n = /[\p{Lu}]/u,
    ...
    c = (h, p, w) => {
      ...
      for (let M = 0; M < h.length; M++) {
        const R = h[M];
        m && n.test(R) ? (h = h.slice(0, M) + "-" + h.slice(M), m = !1, T = E, E = !0, M++) : E && T && t.test(R) ? (h =
          h.slice(0, M - 1) + "-" + h.slice(M - 1), T = E, E = !1, m = !0) : (m = p(R) === R && w(R) !== R, T = E, E =
          w(R) === R && p(R) !== R);
      }
      return h;
    },
    l = (h, p) => (e.lastIndex = 0, h.replace(e, (w) => p(w))),
    o = (h, p) => (a.lastIndex = 0, u.lastIndex = 0, h.replace(a, (w, m) => p(m)).replace(u, (w) => p(w))),
    f = (h, p) => {
      ...
      if (p = {
          ...
          ...p
        }, Array.isArray(h) ? h = h.map((T) => T.trim()).filter((T) => T.length).join("-") : h = h.trim(), h.length ===
        0)
        return "";
      const w = p.locale === !1 ? (T) => T.toLowerCase() : (T) => T.toLocaleLowerCase(p.locale),
        m = p.locale === !1 ? (T) => T.toUpperCase() : (T) => T.toLocaleUpperCase(p.locale);
      return h.length === 1 ? p.pascalCase ? m(h) : w(h) : (h !== w(h) && (h = c(h, w, m)), h = h.replace(i, ""), p
        .preserveConsecutiveUppercase ? h = l(h, w) : h = w(h), p.pascalCase && (h = m(h.charAt(0)) + h.slice(1)), o(
          h, m));
    };
...
class wt {
  ...
  toJSON() {
    ...
    for (let s = Object.getPrototypeOf(this); s; s = Object.getPrototypeOf(s))
      Object.assign(t, Reflect.get(s, "lc_aliases", this)), Object.assign(e, Reflect.get(s, "lc_secrets", this)),
    ...
    return Object.keys(e).forEach((s) => {
      ...
      for (const l of c.reverse()) {
        if (!(l in i) || i[l] === void 0)
          return;
        (!(l in a) || a[l] === void 0) && (typeof i[l] == "object" && i[l] != null ? a[l] = {} : Array.isArray(i[
          l]) && (a[l] = [])), i = i[l], a = a[l];
      }
...
function fs() {
  ...
  return Ce = n, n.prototype.reset = function() {
    ...
    }, r._operationTimeout)), this._operationStart = ( /* @__PURE__ */ new Date()).getTime(), this._fn(this
      ._attempts);
...
function ms() {
  ...
  class e extends Error {
    constructor(u) {
      super(), u instanceof Error ? (this.originalError = u, {
          message: u
        } = u) : (this.originalError = new Error(u), this.originalError.stack = this.stack), this.name = "AbortError",
        this.message = u;
    }
  }
  const r = (a, u, c) => {
...
function gs() {
  return Gt || (Gt = 1, function(n) {
    ...
    function i(c, l, o, f, h) {
      ...
      var p = new s(o, f || c, h),
        w = e ? e + l : l;
      return c._events[w] ? c._events[w].fn ? c._events[w] = [c._events[w], p] : c._events[w].push(p) : (c._events[
        w] = p, c._eventsCount++), c;
    }
    ...
    u.prototype.eventNames = function() {
        ...
        var o;
        return l ? (o = e ? e + l : l, this._events[o] && a(this, o)) : (this._events = new r(), this._eventsCount =
          0), this;
      }, u.prototype.off = u.prototype.removeListener, u.prototype.addListener = u.prototype.on, u.prefixed = e, u
      .EventEmitter = u, n.exports = u;
  }(Le)), Le.exports;
}
var re = {
    exports: {}
...
function vs() {
  return kt || (kt = 1, Oe = (n, t) => (t = t || (() => {}), n.then(
    (e) => new Promise((r) => {
      r(t());
    }).then(() => e),
    (e) => new Promise((r) => {
  ...
  const e = (r, s, i) => new Promise((a, u) => {
    ...
    const c = setTimeout(() => {
      ...
      const l = typeof i == "string" ? i : `Promise timed out after ${s} milliseconds`,
        o = i instanceof Error ? i : new t(l);
...
function ys() {
  if (Bt) return fe;
  Bt = 1, Object.defineProperty(fe, "__esModule", {
    value: !0
  });
...
function _s() {
  if (Vt) return he;
  Vt = 1, Object.defineProperty(he, "__esModule", {
    value: !0
  });
  const n = ys();
  class t {
...
function ws() {
  if (Xt) return ce;
  Xt = 1, Object.defineProperty(ce, "__esModule", {
    value: !0
  });
  const n = gs(),
    t = Es(),
  ...
  class i extends n {
    constructor(u) {
      ...
      if (super(), this._intervalCount = 0, this._intervalEnd = 0, this._pendingCount = 0, this._resolveEmpty = r,
        this._resolveIdle = r, u = Object.assign({
        ...
        }, u), !(typeof u.intervalCap == "number" && u.intervalCap >= 1))
        throw new TypeError(
          `Expected \`intervalCap\` to be a number from 1 and up, got \`${(l = (c = u.intervalCap) === null || c === void 0 ? void 0 : c.toString()) !== null && l !== void 0 ? l : ""}\` (${typeof u.intervalCap})`
          );
      if (u.interval === void 0 || !(Number.isFinite(u.interval) && u.interval >= 0))
        throw new TypeError(
          `Expected \`interval\` to be a finite number >= 0, got \`${(f = (o = u.interval) === null || o === void 0 ? void 0 : o.toString()) !== null && f !== void 0 ? f : ""}\` (${typeof u.interval})`
          );
      this._carryoverConcurrencyCount = u.carryoverConcurrencyCount, this._isIntervalIgnored = u.intervalCap === 1 /
        0 || u.interval === 0, this._intervalCap = u.intervalCap, this._interval = u.interval, this._queue = new u
        .queueClass(), this._queueClass = u.queueClass, this.concurrency = u.concurrency, this._timeout = u.timeout,
        this._throwOnTimeout = u.throwOnTimeout === !0, this._isPaused = u.autoStart === !1;
    }
    ...
    _tryToStartAnother() {
      if (this._queue.size === 0)
        return this._intervalId && clearInterval(this._intervalId), this._intervalId = void 0, this
        ._resolvePromises(), !1;
      if (!this._isPaused) {
    ...
    async add(u, c = {}) {
      return new Promise((l, o) => {
        const f = async () => {
          ...
          try {
            const h = this._timeout === void 0 && c.timeout === void 0 ? u() : t.default(Promise.resolve(u()),
...
function ve() {
  ...
  const n = "2.0.0",
    t = 256,
    e = Number.MAX_SAFE_INTEGER || /* istanbul ignore next */
    9007199254740991,
    r = 16,
    s = t - 6;
  return xe = {
...
function Ee() {
  return zt || (zt = 1, $e = typeof process == "object" && process.env && process.env.NODE_DEBUG && /\bsemver\b/i.test(
    process.env.NODE_DEBUG) ? (...t) => console.error("SEMVER", ...t) : () => {}), $e;
}
var Ht;
  ...
  return Ht || (Ht = 1, function(n, t) {
    ...
    const h = "[a-zA-Z0-9-]",
      ...
      m = (E, T, M) => {
        const R = w(T),
          g = f++;
        i(E, g, T), o[E] = g, c[g] = T, l[g] = R, a[g] = new RegExp(T, M ? "g" : void 0), u[g] = new RegExp(R, M ?
          "g" : void 0);
      };
...
function U() {
  ...
  class u {
    ...
    compareMain(l) {
      return l instanceof u || (l = new u(l, this.options)), this.major < l.major ? -1 : this.major > l.major ? 1 :
        this.minor < l.minor ? -1 : this.minor > l.minor ? 1 : this.patch < l.patch ? -1 : this.patch > l.patch ? 1 :
        0;
    }
    comparePre(l) {
...
function Ms() {
  ...
  return st = (i, a) => {
    ...
    if (!a.rtl)
      ...
      let w;
      for (;
        (w = p.exec(i)) && (!u || u.index + u[0].length !== i.length);)
        (!u || w.index + w[0].length !== u.index + u[0].length) && (u = w), p.lastIndex = w.index + w[1].length + w[2]
        .length;
      p.lastIndex = -1;
    }
    if (u === null)
    ...
    const c = u[2],
      l = u[3] || "0",
      o = u[4] || "0",
      f = a.includePrerelease && u[5] ? `-${u[5]}` : "",
      h = a.includePrerelease && u[6] ? `+${u[6]}` : "";
...
function X() {
  ...
  class t {
    constructor(_, L) {
      ...
      if (_ instanceof i)
        return this.raw = _.value, this.set = [
          [_]
        ], this.formatted = void 0, this;
      if (this.options = L, this.loose = !!L.loose, this.includePrerelease = !!L.includePrerelease, this.raw = _
        .trim().replace(n, " "), this.set = this.raw.split("||").map((C) => this.parseRange(C.trim())).filter((C) => C
    ...
    parseRange(_) {
      const C = ((this.options.includePrerelease && p) | (this.options.loose && w)) + ":" + _,
        O = r.get(C);
      if (O)
        return O;
      const A = this.options.loose,
        x = A ? c[l.HYPHENRANGELOOSE] : c[l.HYPHENRANGE];
      _ = _.replace(x, W(this.options.includePrerelease)), a("hyphen replace", _), _ = _.replace(c[l.COMPARATORTRIM],
        o), a("comparator trim", _), _ = _.replace(c[l.TILDETRIM], f), a("tilde trim", _), _ = _.replace(c[l
        .CARETTRIM], h), a("caret trim", _);
      let q = _.split(" ").map((F) => M(F, this.options)).join(" ").split(/\s+/).map((F) => G(F, this.options));
      A && (q = q.filter((F) => (a("loose invalid filter", F, this.options), !!F.match(c[l.COMPARATORLOOSE])))), a(
        "range list", q);
      const b = /* @__PURE__ */ new Map(),
        D = q.map((F) => new i(F, this.options));
      for (const F of D) {
        if (m(F))
          return [F];
        b.set(F.value, F);
    ...
    intersects(_, L) {
      ...
      return this.set.some((C) => T(C, L) && _.set.some((O) => T(O, L) && C.every((A) => O.every((x) => A.intersects(
        x, L)))));
    }
  ...
  const e = Ps(),
    ...
    M = (S, _) => (S = S.replace(c[l.BUILD], ""), a("comp", S, _), S = v(S, _), a("caret", S), S = g(S, _), a("tildes",
      S), S = y(S, _), a("xrange", S), S = N(S, _), a("stars", S), S),
    R = (S) => !S || S.toLowerCase() === "x" || S === "*",
    g = (S, _) => S.trim().split(/\s+/).map((L) => d(L, _)).join(" "),
    d = (S, _) => {
      const L = _.loose ? c[l.TILDELOOSE] : c[l.TILDE];
      return S.replace(L, (C, O, A, x, q) => {
        a("tilde", S, C, O, A, x, q);
        let b;
        return R(O) ? b = "" : R(A) ? b = `>=${O}.0.0 <${+O + 1}.0.0-0` : R(x) ? b =
          `>=${O}.${A}.0 <${O}.${+A + 1}.0-0` : q ? (a("replaceTilde pr", q), b =
            `>=${O}.${A}.${x}-${q} <${O}.${+A + 1}.0-0`) : b = `>=${O}.${A}.${x} <${O}.${+A + 1}.0-0`, a(
            "tilde return", b), b;
      });
    },
    v = (S, _) => S.trim().split(/\s+/).map((L) => I(L, _)).join(" "),
    I = (S, _) => {
      a("caret", S, _);
      const L = _.loose ? c[l.CARETLOOSE] : c[l.CARET],
        C = _.includePrerelease ? "-0" : "";
      return S.replace(L, (O, A, x, q, b) => {
        a("caret", S, O, A, x, q, b);
        let D;
        return R(A) ? D = "" : R(x) ? D = `>=${A}.0.0${C} <${+A + 1}.0.0-0` : R(q) ? A === "0" ? D =
          `>=${A}.${x}.0${C} <${A}.${+x + 1}.0-0` : D = `>=${A}.${x}.0${C} <${+A + 1}.0.0-0` : b ? (a(
              "replaceCaret pr", b), A === "0" ? x === "0" ? D = `>=${A}.${x}.${q}-${b} <${A}.${x}.${+q + 1}-0` :
            D = `>=${A}.${x}.${q}-${b} <${A}.${+x + 1}.0-0` : D = `>=${A}.${x}.${q}-${b} <${+A + 1}.0.0-0`) : (a(
              "no pr"), A === "0" ? x === "0" ? D = `>=${A}.${x}.${q}${C} <${A}.${x}.${+q + 1}-0` : D =
            `>=${A}.${x}.${q}${C} <${A}.${+x + 1}.0-0` : D = `>=${A}.${x}.${q} <${+A + 1}.0.0-0`), a("caret return",
            D), D;
      });
    },
    y = (S, _) => (a("replaceXRanges", S, _), S.split(/\s+/).map((L) => P(L, _)).join(" ")),
    P = (S, _) => {
      S = S.trim();
      ...
      return S.replace(L, (C, O, A, x, q, b) => {
        ...
        const D = R(A),
          ...
          F = k || R(q),
          ee = F;
        return O === "=" && ee && (O = ""), b = _.includePrerelease ? "-0" : "", D ? O === ">" || O === "<" ? C =
          "<0.0.0-0" : C = "*" : O && ee ? (k && (x = 0), q = 0, O === ">" ? (O = ">=", k ? (A = +A + 1, x = 0, q =
            0) : (x = +x + 1, q = 0)) : O === "<=" && (O = "<", k ? A = +A + 1 : x = +x + 1), O === "<" && (b =
            "-0"), C = `${O + A}.${x}.${q}${b}`) : k ? C = `>=${A}.0.0${b} <${+A + 1}.0.0-0` : F && (C =
            `>=${A}.${x}.0${b} <${A}.${+x + 1}.0-0`), a("xRange return", C), C;
      });
    },
    N = (S, _) => (a("replaceStars", S, _), S.trim().replace(c[l.STAR], "")),
    G = (S, _) => (a("replaceGTE0", S, _), S.trim().replace(c[_.includePrerelease ? l.GTE0PRE : l.GTE0], "")),
    W = (S) => (_, L, C, O, A, x, q, b, D, k, F, ee) => (R(C) ? L = "" : R(O) ? L = `>=${C}.0.0${S ? "-0" : ""}` : R(
      A) ? L = `>=${C}.${O}.0${S ? "-0" : ""}` : x ? L = `>=${L}` : L = `>=${L}${S ? "-0" : ""}`, R(D) ? b = "" : R(k) ?
      b = `<${+D + 1}.0.0-0` : R(F) ? b = `<${D}.${+k + 1}.0-0` : ee ? b = `<=${D}.${k}.${F}-${ee}` : S ? b =
      `<${D}.${k}.${+F + 1}-0` : b = `<=${b}`, `${L} ${b}`.trim()),
    Y = (S, _, L) => {
  ...
  class t {
    ...
    parse(o) {
      ...
      this.operator = h[1] !== void 0 ? h[1] : "", this.operator === "=" && (this.operator = ""), h[2] ? this.semver =
        new u(h[2], this.options.loose) : this.semver = n;
    }
    toString() {
      return this.value;
    }
  ...
  return dt = (o, f, h, p) => {
    ...
    for (let R = 0; R < f.set.length; ++R) {
      ...
      let d = null,
        v = null;
      if (g.forEach((I) => {
          I.semver === e && (I = new t(">=0.0.0")), d = d || I, v = v || I, w(I.semver, d.semver, p) ? d = I : E(I
            .semver, v.semver, p) && (v = I);
...
function Vs() {
  ...
  return vt = (e, r, s) => {
    ...
    const l = [];
    for (const [h, p] of i)
      h === p ? l.push(h) : !p && h === c[0] ? l.push("*") : p ? h === c[0] ? l.push(`<=${p}`) : l.push(
      `${h} - ${p}`) : l.push(`>=${h}`);
    const o = l.join(" || "),
...
function Xs() {
  ...
  const n = X(),
    ...
    c = (f, h, p) => {
      ...
      let m, E;
      for (const y of f)
        y.operator === ">" || y.operator === ">=" ? m = l(m, y, p) : y.operator === "<" || y.operator === "<=" ? E = o(
          E, y, p) : w.add(y.semver);
      if (w.size > 1)
        return null;
      let T;
      if (m && E) {
      ...
      let M, R, g, d, v = E && !p.includePrerelease && E.semver.prerelease.length ? E.semver : !1,
        I = m && !p.includePrerelease && m.semver.prerelease.length ? m.semver : !1;
      v && v.prerelease.length === 1 && E.operator === "<" && v.prerelease[0] === 0 && (v = !1);
      for (const y of h) {
        if (d = d || y.operator === ">" || y.operator === ">=", g = g || y.operator === "<" || y.operator === "<=", m) {
          if (I && y.semver.prerelease && y.semver.prerelease.length && y.semver.major === I.major && y.semver.minor ===
            I.minor && y.semver.patch === I.patch && (I = !1), y.operator === ">" || y.operator === ">=") {
...
function zs() {
  return Dr || (Dr = 1, function(n) {
    const e = (i = 0) => (a) => `\x1B[${38 + i};5;${a}m`,
      r = (i = 0) => (a, u, c) => `\x1B[${38 + i};2;${a};${u};${c}m`;
    ...
    function s() {
      ...
      return Object.defineProperty(a, "codes", {
        ...
        a.bgColor.ansi256 = e(10), a.bgColor.ansi16m = r(10), Object.defineProperties(a, {
          rgbToAnsi256: {
            value: (u, c, l) => u === c && c === l ? u < 8 ? 16 : u > 248 ? 231 : Math.round((u - 8) / 247 * 24) +
              232 : 16 + 36 * Math.round(u / 255 * 5) + 6 * Math.round(c / 255 * 5) + Math.round(l / 255 * 5),
            enumerable: !1
          },
          hexToRgb: {
            value: (u) => {
...
class Q {
  constructor(t, e, r, s, i, a, u, c, l, o) {
    ...
    this.id = t, this.title = e, this.sessionType = r, this.createdAt = s, this.lastModified = i, this.version = a,
      this.initialContext = u, this.history = c, this.nextMessage = l, this.executionMetadata = o;
  }
  /**
  ...
  getMessageById(t) {
    var e;
    return ((e = this.nextMessage) == null ? void 0 : e.id) === t ? this.nextMessage : this.history.find((r) => r
      .id === t);
  }
  /**
      ...
      if (i.assistant.toolCalls)
        for (const a of i.assistant.toolCalls)
          a.status === $.Completed && !i.toolResponse && t.push({
            ...
            path: `message.${i.id}.toolCall.${a.id}`,
            severity: "warning"
          }), (a.status === $.Executing || a.status === $.Completed || a.status === $.Failed) && !a.executedAt && e
          .push({
...
function ae(n, t, e) {
  ...
  return t === $.Approved && !s.approvedAt && (s.approvedAt = r), t === $.Executing && !s.executedAt && (s.executedAt =
    r), (t === $.Completed || t === $.Failed) && !s.completedAt && (s.completedAt = r), {
    ...n,
    status: t,
    ...s
  };
...
function $n(n, t, e) {
  ...
  const s = j(),
    i = ((u = n.executionMetadata) == null ? void 0 : u.startTime) ?? n.requestedAt,
    a = {
...
class nn extends J {
  ...
  apply(t) {
    ...
    const e = t.history.map((i) => {
      var a;
      return (a = i.assistant.toolCalls) != null && a.some((u) => u.id === this.toolCallId) ? $t(i, this
        .toolCallId, this.newStatus) : i;
    });
    return Promise.resolve(B(t, {
      history: e
    }));
...
class an extends J {
  ...
  validate(t) {
    ...
    const e = [],
      r = [],
      s = t.getMessageById(this.messageId);
    return s ? (((a = s.assistant.toolCalls) == null ? void 0 : a.find((u) => u.id === this.response.callId)) || e
      .push({
        code: "TOOL_CALL_NOT_FOUND",
...
function un() {
  ...
  var n = typeof Reflect == "object" ? Reflect : null,
    t = n && typeof n.apply == "function" ? n.apply : function(d, v, I) {
  ...
  pe.exports = i, pe.exports.once = T, i.EventEmitter = i, i.prototype._events = void 0, i.prototype._eventsCount = 0, i
  ...
  Object.defineProperty(i, "defaultMaxListeners", {
    ...
    (this._events === void 0 || this._events === Object.getPrototypeOf(this)._events) && (this
      ._events = /* @__PURE__ */ Object.create(null), this._eventsCount = 0), this._maxListeners = this
  ...
  function l(g, d, v, I) {
    var y, P, N;
    if (u(v), P = g._events, P === void 0 ? (P = g._events = /* @__PURE__ */ Object.create(null), g._eventsCount = 0) :
      (P.newListener !== void 0 && (g.emit(
        "newListener",
        d,
        v.listener ? v.listener : v
      ), P = g._events), N = P[d]), N === void 0)
      N = P[d] = v, ++g._eventsCount;
    else if (typeof N == "function" ? N = P[d] = I ? [v, N] : [N, v] : I ? N.unshift(v) : N.push(v), y = c(g), y > 0 &&
      N.length > y && !N.warned) {
      N.warned = !0;
  ...
  function o() {
    if (!this.fired)
      return this.target.removeListener(this.type, this.wrapFn), this.fired = !0, arguments.length === 0 ? this.listener
        .call(this.target) : this.listener.apply(this.target, arguments);
  }
  ...
  i.prototype.once = function(d, v) {
    ...
    if (I = y[d], I === void 0)
      return this;
    if (I === v || I.listener === v)
      --this._eventsCount === 0 ? this._events = /* @__PURE__ */ Object.create(null) : (delete y[d], y
        .removeListener && this.emit("removeListener", d, I.listener || v));
      ...
      if (P < 0)
        return this;
      P === 0 ? I.shift() : m(I, P), I.length === 1 && (y[d] = I[0]), y.removeListener !== void 0 && this.emit(
    ...
    if (I.removeListener === void 0)
      return arguments.length === 0 ? (this._events = /* @__PURE__ */ Object.create(null), this._eventsCount = 0) : I[
        d] !== void 0 && (--this._eventsCount === 0 ? this._events = /* @__PURE__ */ Object.create(null) : delete I[
        d]), this;
    if (arguments.length === 0) {
      ...
      return this.removeAllListeners("removeListener"), this._events = /* @__PURE__ */ Object.create(null), this
        ._eventsCount = 0, this;
    }
...
class jn {
  ...
  async ensureSessionsDir() {
    try {
      await H.promises.mkdir(this.sessionsDir, {
        recursive: !0
      });
    } catch (t) {
      if (t.code !== "EEXIST")
  ...
  async loadSession(t) {
    try {
      const e = this.getSessionPath(t),
        r = await H.promises.readFile(e, "utf8");
      return JSON.parse(r);
    } catch (e) {
      if (e.code === "ENOENT")
        return null;
  ...
  async listSessionIds() {
    try {
      return await this.ensureSessionsDir(), (await H.promises.readdir(this.sessionsDir)).filter((e) => e.endsWith(
        ".json")).map((e) => Se.basename(e, ".json"));
    } catch (t) {
      if (t.code === "ENOENT")
        return [];
      throw t;
  ...
  async saveWithVersion(t, e) {
    ...
    try {
      const a = await H.promises.readFile(r, "utf8"),
        u = JSON.parse(a);
      if (u.version !== e)
...
class Gn extends ln.EventEmitter {
  ...
  async listSessions(e = {}) {
    ...
    return (await Promise.all(a)).filter((l) => l !== null).sort((l, o) => o.lastModified - l.lastModified).slice(r,
      r + s);
  }
  /**
  ...
  async approveToolCall(e, r, s) {
    await this.withSessionLock(e, async (i) => {
      const a = s.approved ? $.Approved : $.Denied,
        u = J.updateToolCallStatus(r, a);
      await this.applySessionEdit(i, u), await this.eventBus.emit({
        id: K(),
        sessionId: e,
        timestamp: j(),
