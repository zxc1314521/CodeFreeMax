...
var p = /* @__PURE__ */ ((e) => (e.Chat = "chat", e.Spec = "spec", e.Hook = "hook", e))(p || {}),
  l = /* @__PURE__ */ ((e) => (e.Queued = "queued", e.Running = "running", e.WaitingForApproval =
    "waiting_for_approval", e.Completed = "completed", e.Failed = "failed", e.Aborted = "aborted", e))(l || {}),
  m = /* @__PURE__ */ ((e) => (e.ChatAgent = "chat", e.AskAgent = "ask", e.SpecGeneration = "spec", e.CreateHook =
    "hook", e.TestGeneration = "test", e.ValidationDriven = "validation", e))(m || {}),
  o = /* @__PURE__ */ ((e) => (e.Pending = "pending", e.AwaitingApproval = "awaiting_approval", e.Approved = "approved",
    e.Denied = "denied", e.Executing = "executing", e.Completed = "completed", e.Failed = "failed", e))(o || {});
  ...
  get executionStatus() {
    return this.assistant.isStreaming ? l.Running : this.pendingApprovals.length > 0 ? l.WaitingForApproval : !this
      .assistant.toolCalls || this.assistant.toolCalls.length === 0 ? l.Completed : this.assistant.toolCalls.some(({
        status: t
      }) => t === o.Failed) ? l.Failed : this.assistant.toolCalls.some(({
        status: t
      }) => t === o.Executing) ? l.Running : this.assistant.toolCalls.every(({
        status: t
      }) => t === o.Completed) ? l.Completed : l.Queued;
  }
}
...
function L(e, t, s) {
  const a = r(),
    n = {};
  s === o.Approved && (n.approvedAt = a), s === o.Executing && (n.executedAt = a), (s === o.Completed || s === o
