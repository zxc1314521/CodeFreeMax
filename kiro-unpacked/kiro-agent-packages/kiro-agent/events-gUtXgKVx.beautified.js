...
class d {
  ...
  subscribeToSession(t, s) {
    ...
    return this.sessionSubscriptions.has(t) || this.sessionSubscriptions.set(t, /* @__PURE__ */ new Set()), (o = this
      .sessionSubscriptions.get(t)) == null || o.add(i), this.tokenToSubscription.set(e, i), e;
  }
  /**
