...
const channel = vscode.window.createOutputChannel("Kiro Logs", { log: true });
const logs = [];
...
const mcpLogChannel = vscode.window.createOutputChannel("Kiro - MCP Logs", { log: true });
...
export {
  DEFAULT_IGNORE_FILETYPES as D,
  TrustedError as T,
  isBlockedAccessError as a,
  mapUnknownToErrorType as b,
  DEFAULT_IGNORE_DIRS as c,
  defaultIgnoreFile as d,
  defaultIgnoreDir as e,
  DEFAULT_IGNORE as f,
  gitIgnoreArrayFromFile as g,
  isAbortError as i,
  logger as l,
  mcpLogger as m
};
