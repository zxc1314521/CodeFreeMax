...
const RemoteToolsMetrics = new MetricReporter(TelemetryNamespace.Feature, "remote_tools");
...
const WebFetchMetrics = new MetricReporter(TelemetryNamespace.Feature, "web_fetch");
...
class WebFetchRecorder {
   ...
   */
  static start() {
    const baseRecorder = ToolRecorder.start(Tool.WebFetch);
...
export {
  RemoteToolRecorder as R,
  WebFetchRecorder as W,
  recordPowersEvent as a,
  recordPowersHistogram as b,
  recordRemoteToolsEvent as c,
  recordRemoteToolsHistogram as d,
  recordWebFetchEvent as e,
  recordChatWebviewEvent as r
};