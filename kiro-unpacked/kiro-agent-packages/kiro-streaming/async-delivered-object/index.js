...
var o = (t, e, s) => e in t ? i(t, e, { enumerable: !0, configurable: !0, writable: !0, value: s }) : t[e] = s;
var r = (t, e, s) => o(t, typeof e != "symbol" ? e + "" : e, s);
import { K as l } from "../powers-Cm4DUTtG.js";
class m extends l {
  /**
...
class a {
   ...
   */
  complete(e) {
    this.isComplete || (e !== void 0 && (this.value = e), this.isComplete = !0, this.resolvePromise && this.resolvePromise(this.value));
  }
  /**
