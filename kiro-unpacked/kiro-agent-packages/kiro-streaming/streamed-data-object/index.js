...
import { AsyncStream as A } from "../async-stream/index.js";
import { K as O } from "../powers-Cm4DUTtG.js";
class l extends O {
  /**
...
const o = class o {
  ...
  constructor(t) {
    ...
    this.data = t, this.dataByKeypath.set(o.ROOT, this.data), this._refreshDataReferencesAtKeypath(o.ROOT, this.data), this._updateOpenKeys(o.ROOT, t);
  }
  /**
  ...
  _appendArrayAtKeypath(t, e) {
    ...
    if (!Array.isArray(s))
      throw new u(t, "array-like", typeof s);
    const r = s.length, i = `${t}.${r}`;
    s.push(e), this.dataByKeypath.set(i, e), this._refreshDataReferencesAtKeypath(i, e), this._emitArrayExtended(t, r, e);
  }
  /**
  ...
  _mergeObjectAtKeypath(t, e) {
    const s = this.dataByKeypath.get(t), r = typeof s, i = typeof e;
    if (!s) {
  ...
  _setDataAtKeypath(t, e, s) {
    const r = t.lastIndexOf("."), i = t.slice(0, Math.max(0, r)), a = t.slice(Math.max(0, r + 1)), h = this.dataByKeypath.get(i);
    if (!h)
      throw new b(i);
    if (Array.isArray(e)) {
      const c = [];
      this.dataByKeypath.set(t, c), Object.assign(h, { [a]: c }), this._refreshDataReferencesAtKeypath(t, c);
    ...
    h[a] && h[a] === e || (this.dataByKeypath.set(t, e), Object.assign(h, { [a]: e }), this._refreshDataReferencesAtKeypath(t, e), typeof e == "string" ? this._emitStringExtended(t, e, s || e) : this._emitValueWritten(t, e));
  }
  /**
  ...
  extendStringAtKeypath(t, e) {
    const s = this.dataByKeypath.get(t), r = typeof s;
    if (!s) {
      this._setDataAtKeypath(t, e), this._updateOpenKeys(t, e);
      return;
    }
  ...
  _getSubscribers(t) {
    const e = [...this.subscribersByKeypath.keys()], s = ["*"];
    for (const i of e)
